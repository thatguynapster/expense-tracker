...
async function main() {
  ...
  const testData: SyncedAppData = {
    ...
    transactions: [],
    disciplineState: { id: 'discipline_verify_test', totalWithdrawnFromSavings: 0, totalExtraSavings: 0, safeToSpendWarningThreshold: 50, createdAt: now(), updatedAt: now(), syncedAt: null, deletedAt: null },
    loans: [
